      ...
      >
        ...
        >
          ...
          {hasLicense && licenseDetails ? (
            ...
            <div className="space-y-6">
              <header>
                <div className="inline-block bg-orange-500/10 text-orange-400 text-xs font-semibold px-3 py-1 rounded-full mb-2">
                  UNLOCK ALL FEATURES
                </div>
                <h2 className="text-2xl font-bold text-white mt-1">
                  Get BetterApp Pro
                ...
                <p className="text-gray-400 mt-2 text-sm">
                  Join 500+ developers who use BetterApp to increase their App
                  Store rankings.
                </p>
              </header>
              <ul className="space-y-3 text-sm text-gray-300">
                <li className="flex items-center gap-2">
                  ...
                  Discover keywords your app already ranks for
                </li>
                <li className="flex items-center gap-2">
                  <svg
                    className="w-4 h-4 text-green-400 flex-shrink-0"
                  ...
                  Extract competitor keywords instantly
                </li>
                <li className="flex items-center gap-2">
                  <svg
                    className="w-4 h-4 text-green-400 flex-shrink-0"
                ...
                <li className="flex items-center gap-2">
                  ...
                  CSV exports & performance reports
                </li>
              </ul>
              <div className="bg-gray-800/50 rounded-lg p-4 text-center">
                <span className="text-3xl font-bold text-white">$109</span>
              ...
              <button
                ...
                className="w-full flex items-center justify-center gap-2 px-4 py-4 rounded-lg bg-orange-600 text-white font-semibold hover:bg-orange-700 transition-colors disabled:opacity-50 text-lg"
              >
                {isStartingCheckout
                  ? "Redirecting..."
